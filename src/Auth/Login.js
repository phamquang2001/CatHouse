            ...
            < div className="login-signup d-flex justify-content-center">
                ...
                <div className='login-table mt-5'>
                    ...
                    <div className="auth-content form-group col-10  mx-auto">
                        ...
                        <div className='password-input'>
                            ...
                            />
                            {
                                showPass === true ?
                                    ...
                                    <BsEye className='icon-eye hide' onClick={() => setShowPass(!showPass)} /> :
                                    <BsEyeSlashFill className='icon-eye show' onClick={() => setShowPass(!showPass)} />
                            }
                        ...
                        >
                            {
                                isLoading && <span className="spinner-grow spinner-grow-sm" style={{ color: "#ffffff00" }} role="status"  ></span>
                            }
                            <span
