...
import { getAllProducts, getUserLimit, getApiSearch } from "../services/apiServices"
        ...
        <div className="adminPage container">
            ...
            <div className="admin-header d-flex justify-content-between">
                ...
                <div className="button-header mb-3">
                    <button className="btn btn-success ms-3" onClick={() => handleShowAddNew()}
                                        ...
                                        <tr key={uuidv4()} className="align-middle">
                                            ...
                                            <td className="button-control d-flex ">
                                                ...
                                                <div hidden={inforUser.role !== "admin" ? true : false} >
                                                    ...
                                                    <BsPencilFill className="button update mx-1" onClick={() => handleShowUpdate(product)} />
                                                </div>

                                                <div hidden={inforUser.role !== "admin" ? true : false} >
                                                    <RiDeleteBinFill className="button delete mx-1" onClick={() => handleShowDelete(product)} />
                                                </div>
                                            </td>
