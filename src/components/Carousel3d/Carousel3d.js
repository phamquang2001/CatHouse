...
import { EffectCoverflow, Pagination, Navigation, Autoplay, SwiperCore } from 'swiper';
                ...
                >
                    {
                        dataCategory.map((item) => {
                            return (
                                ...
                                <SwiperSlide className='item-carousel' key={uuidv4()} onClick={() => {
                                    ...
                                    >
                                        ...
                                        <h4 className='name-category text-center pt-2'>{item.name}</h4>
                                    </div>
                                </SwiperSlide>
            ...
            }
            {
                ...
                >
                    <SwiperSlide>
                        <div className='carousel-image' >
                            <Skeleton />
                            <h4 className='name-category text-center'>
