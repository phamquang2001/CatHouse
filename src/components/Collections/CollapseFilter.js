...
function CollapseFilter(props) {
    ...
    return (
        <Accordion defaultActiveKey={['0', '1']} alwaysOpen className='item-filter-content'>
            <Accordion.Item eventKey="0" className='item-content'>
                <Accordion.Header>Danh mục sản phẩm</Accordion.Header>
                <Accordion.Body >
                    <div className={`item-collection collection ${selected === "all" ? "active" : ""}`} onClick={() => {
                    ...
                    <div className={`item-collection collection ${selected === "Mèo" ? "active" : ""}`} onClick={() => {
                    ...
                    <div className={`item-collection collection ${selected === "Thức ăn" ? "active" : ""}`} onClick={() => {
                    ...
                    <div className={`item-collection collection ${selected === "Vệ sinh" ? "active" : ""}`} onClick={() => {
                    ...
                    <div className={`item-collection collection ${selected === "Sức khoẻ" ? "active" : ""}`} onClick={() => {
                    ...
                    <div className={`item-collection collection ${selected === "Phụ kiện" ? "active" : ""}`} onClick={() => {
                    ...
                    <div className={`item-collection collection ${selected === "Combo" ? "active" : ""}`} onClick={() => {
            ...
            <Accordion.Item eventKey="1" className='item-content'>
                ...
                <Accordion.Body>
                    <div className='item-collection' >
                        <input type="checkbox" id="p1" name="cc" checked={checkP1} onChange={() => { let a = 1 }}></input>
                        <label htmlFor="p1" className='checkMark' onClick={() => handleChecked("p1")}></label>
                        <label htmlFor="p1" onClick={() => handleChecked("p1")}>
                            <span>Dưới 1.000.000₫</span>
                        </label>
                    </div>
                    <div className='item-collection' >
                        <input type="checkbox" id="p2" name="cc" className='inputCheck' checked={checkP2} onChange={() => { let a = 1 }} />
                        <label htmlFor="p2" className='checkMark' onClick={() => handleChecked("p2")}></label>
                        <label htmlFor="p2" onClick={() => handleChecked("p2")}>
                            <span>1.000.000₫ - 2.000.000₫</span>
                        </label>
                    </div>
                    <div className='item-collection' >
                        <input type="checkbox" id="p3" name="cc" className='inputCheck' checked={checkP3} onChange={() => { let a = 1 }} />
                        <label htmlFor="p3" className='checkMark' onClick={() => handleChecked("p3")}></label>
                        <label htmlFor="p3" onClick={() => handleChecked("p3")}>
                            <span> 2.000.000₫ - 3.000.000₫</span>
                        </label>
                    </div>
                    <div className='item-collection' >
                        <input type="checkbox" id="p4" name="cc" className='inputCheck' checked={checkP4} onChange={() => { let a = 1 }} />
                        <label htmlFor="p4" className='checkMark' onClick={() => handleChecked("p4")}></label>
                        <label htmlFor="p4" onClick={() => handleChecked("p4")}>
                            <span>3.000.000₫ - 4.000.000₫</span>
                        </label>
                    </div>
                    <div className='item-collection' >
                        <input type="checkbox" id="p5" name="cc" className='inputCheck' checked={checkP5} onChange={() => { let a = 1 }} />
                        <label htmlFor="p5" className='checkMark' onClick={() => handleChecked("p5")}></label>
