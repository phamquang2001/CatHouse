    ...
    return (
        <div className='collection-content container'>
            <div className='nav-link-address pb-2'>
                ...
                <span> / </span>
                <span style={{ cursor: "pointer" }} onClick={() => navigate("/collections/all")}>
                    Danh mục
                </span>
                <span> / </span>
                ...
                <div className='collection-product'>
                    ...
                    <div className='collection-product-content pt-3'>
                        <div className='collection-product-header pb-3'>
                            ...
                            <span><b>{countProduct}</b> sản phẩm
                                <span className='icon-filter' onClick={() => setShowModalFilter(true)}>
                                    Bộ lọc
...

                        {
                            ...
                            <div className='filter-price mb-3'>
                                ...
                                <span className='close-filter-price ms-2' onClick={() => setRemoveFilter(!removeFilter)}>  X</span>
                            </div>
                        }
                        <ListProducts
