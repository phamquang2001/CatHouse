...
const Footer = () => {
    return (
        <div>
            <MDBFooter bgColor='light' className='text-center text-lg-start text-muted footer-component-bootstrap mt-5'>
                    ...
                    <MDBContainer className='text-center text-md-start mt-5'>
                        <MDBRow className='mt-3'>
                            ...
                            <MDBCol md="4" lg="3" xl="3" className='mx-auto mb-md-0 mb-4'>
                                ...
                                <p>
                                    <FaPhoneAlt className="icon-contact phone me-3" /> +84 5678 9999 9
                                </p>
                ...
                <div className='text-center p-4' style={{ backgroundColor: 'rgba(0, 0, 0, 0.05)' }}>
                    © 2023 Copyright:
                    <a className='text-reset fw-bold' href='https://github.com/ND-Long/Frs-ManagerUser.git' target="_blank">
                        PETSHOP
                    </a>
                </div >
            </MDBFooter >
