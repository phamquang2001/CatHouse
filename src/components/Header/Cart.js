...
function Cart(props) {
    ...
    return (
        <div className='cart-model mt-5' >
            ...
            <Modal show={show} onHide={handleClose} className='cart-shopping pt-5 mt-5'>
                                                ...
                                                return (
                                                    <div key={item.id} className='cart-product mt-1 mb-5'  >
                                                        ...
                                                        <div className="detail-product-cart">
                                                            <div className='detail' onClick={() => handleDetailsProduct(item.id)}>
                                                                {` ${item.description.slice(0, 30)} ... `}
                                                            </div>
                                                            <div className="price me-5">
                                                                {result}
                                                            </div>

                                                        </div>
                                                        <GrClose className='icon-delete-cart ' onClick={() => handleDeleteCart(item)} />
                                                    </div>
                                                )
                                            })
                                        }
