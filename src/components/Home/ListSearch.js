...
function ListSearch(props) {
    ...
    return (
        <div className="home-page-list-search container" ref={ref} onMouseDown={onMouseDown}>
            <div className="list-search-item header">
                <h6 className="header-home-page-list-search">Xu hướng tìm kiếm</h6>
                <button className="btn-home-page-list-search" onClick={() => navigate('/collections/all')}>xem ngay</button>
            </div>
            <div className="list-search-item" onClick={() => navigate('/collections/Mèo')}>
                <div>
            ...
            <div className="list-search-item" onClick={() => navigate('/collections/Thức ăn')}>
                <div>
            ...
            <div className="list-search-item" onClick={() => navigate('/collections/Sữa, Thực phẩm bổ sung')}>
                <div>
            ...
            <div className="list-search-item" onClick={() => navigate('/collections/Vệ sinh')}>
                <div>
            ...
            <div className="list-search-item" onClick={() => navigate('/collections/Sữa tắm')}>
                <div>
            ...
            <div className="list-search-item" onClick={() => navigate('/collections/Sức khoẻ')}>
                <div>
            ...
            <div className="list-search-item" onClick={() => navigate('/collections/Phụ kiện')}>
                <div>
            ...
            <div className="list-search-item" onClick={() => navigate('/collections/Đồ chơi')}>
                <div>
