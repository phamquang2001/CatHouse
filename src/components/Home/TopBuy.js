        ...
        <div className='mt-5 '>
            <div className="header-top-buy container">
                ...
                <div className='filter-top-buy' ref={ref} onMouseDown={onMouseDown} >
                    <span className={`item-filter ${topBuyClicked === 1 ? "active" : ""}`} onClick={() => {
                        setTopBuyClicked(1)
                        setCollections("Mèo")
                    ...
                    >Mèo có SẴN</span>
                    <span className={`item-filter ${topBuyClicked === 2 ? "active" : ""}`} onClick={() => {
                        setTopBuyClicked(2)
                    ...
                    <span className={`item-filter ${topBuyClicked === 3 ? "active" : ""}`} onClick={() => {
                        setTopBuyClicked(3)
                        setCollections("Dịch vụ Grooming&Spa thú cưng Website")
                        setInfoButton("GROOMING&SPA")
                    }
                    }>GROOMING&SPA</span>
                    <span className={`item-filter ${topBuyClicked === 4 ? "active" : ""}`} onClick={() => {
                        setTopBuyClicked(4)
            ...
            <div className='button-footer-top-buy' onClick={() => navigate(`/collections/${collections}`)}>
                <span><span className='show-footer-button'>Xem tất cả</span> {infoButton}</span>
            </div>
        </div>
    );
}
