...
import { addToCartRedux, decreaseCart, increaseCart, SHOW_CART } from '../../redux/actions/productActions';
    ...
    return (
        ...
        <div className='detail-product container'>
            <div className='nav-link-address pb-2'>
                ...
                / <span style={{ cursor: "pointer" }} onClick={() => navigate(`/collections/${dataDetail.collection}`)}>{dataDetail.collection}</span> / {dataDetail.description}
            </div>
                        ...
                        <div className='quantity-product-detail mt-5'>
                            ...
                            <div className='footer-product-detail'>
                                <div className="quantity">
                                    <span className='minus' onClick={() => setQuantityDetail(quantityDetail < 2 ? 1 : quantityDetail - 1)}>-</span>
                                    <span>{quantityDetail}</span>
                                    <span className='plus' onClick={() => setQuantityDetail(prev => prev + 1)}>+</span>
                                </div>

                            </div>
                        </div>
                        <div className='button-footer'>
                            <button onClick={() => handelIncreaseProduct(dataDetail)} className='btn btn-danger add-to-cart'>
                                Thêm vào giỏ
                            </button>
