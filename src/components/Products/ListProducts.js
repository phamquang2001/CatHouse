        ...
        try {
            ...
            if (collections.length > 0) {
                ...
                if (collections === "all") {
                    ...
                    dataCollections = dataNewReverse.filter(item => item.collection == collections)
                ...
                dataCollections = dataNewReverse.filter(item => item.collection === "Mèo")
                setDataNew(dataCollections)
        ...
        <>
            ...
            <div className='listProduct-content ' >
...

                {
                    ...
                    isLoading && dataNew.map((product, index) => {
                        return (
                            <div key={uuidv4()}>
