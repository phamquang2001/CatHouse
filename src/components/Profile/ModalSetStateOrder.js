...
function ModalSetStateOrder(props) {
    ...
    return (
        <div className=''>
            ...
            <Modal show={show} onHide={handleClose} className="modal-state-order mt-5 pt-5">
                <Modal.Header closeButton className='container' style={{ border: "none" }}>
                ...
                <Modal.Footer style={{ border: "none" }}>
                    ...
                    <Button variant="success" onClick={handleSuccess} disabled={isLoading}>
