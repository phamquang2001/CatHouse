    ...
    return (
        <div className='profile-page p-4  pt-5'>
            <div className='colum-info'>
                ...
                <button className={`btn btn-white text-left ${selected == 1 ? "active" : ""}`} onClick={handleClick(1)}>Thông tin cá nhân</button>
                <button className={`btn btn-white text-left ${selected == 2 ? "active" : ""}`} onClick={handleClick(2)}>Danh sách đơn hàng</button>
                ...
                <button disabled={isLoading} className='btn btn-white text-left' onClick={() => handleLogOut()} >
                    Thoát
                    <div className="spinner-border spinner-border-sm mx-2" role="status" hidden={!isLoading}>
