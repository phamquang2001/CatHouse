                ...
                dataSeach.length > 0 && isLoading ?
                    <>
                        <div className='label-product text-center'>
                            {
                                param.keyWord &&
                                <p >Có <b>{dataSeach.length} sản phẩm</b> cho tìm kiếm</p>
                            }
                        </div>
                        <hr />
                        <p className=' mx-3'>Kết quả tìm kiếm cho "<b>{keySearch}</b>"</p>
                        <div className='listProduct-content  p-0' >

                            {
                                isLoading && dataSeach.map((product, index) => {
                                    return (
                                        <ProductCard
                    ...
                    <>
                        <hr />
                        {
                            !isLoading ?
                                ...
                                :
                                <div
                                    className='text-center pb-5 mb-5' style={{ fontWeight: "600" }}
                                >
                                    {
                                        keySearch &&
                                        <>
                                            ...
                                            <p style={{ fontWeight: "400" }}>
                                                Không tìm thấy "<b>{keySearch}</b>". Vui lòng kiểm tra chính tả, sử dụng các từ tổng quát hơn và thử lại!
                                            </p>
                                        </>
                                    }
