...
const postCreateProduct = (description, collection, category, price, image1, image2, image3) => {
    return axios.post('/products', { description, collection, category, price, image1, image2, image3 })
}

const putUpdateProduct = (id, description, collection, category, price, image1, image2, image3) => {
    return axios.patch(`/products/${id}`, { description, collection, category, price, image1, image2, image3 })
}
...
export {
    ...
    putUpdateInfoUser, getOneUser, getApiSearch,
    getAllCategory, putCartOrder
}